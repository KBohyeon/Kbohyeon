...
## 🎲 Random_lolteam(게임 내전 랜덤 분배 사이트)
📆 개발 기간: 2023.05 – 2023.06

🧠 프로젝트 개요  
매번 게임 내전을 위해 사다리 타기를 입력하기 번거로워 개발한 사이트입니다.
10명의 인원을 입력후 랜덤으로 5대5 팀을 분배 시켜주며 체크된 2명은(선택시) 항상 다른 팀으로 배정 할 수 있습니다.
게임 종료 후 승률을 저장하여 개인 승률 정보를 보여줍니다.
...
🧰 기술 스택   
- PHP, HTML, Mysql, Apache
  
📎 자세한 정보  
[Random_lolteam 바로가기](https://github.com/KBohyeon/Random_lolteam)

## 📱 lunch_archive(성공을 위한 다목적 런치 아카이브)
📆 개발 기간: 2024.09 – 2024.09

🧠 프로젝트 개요  
친구들과의 점심 기록을 공유 하기 위한 간단한 사이트입니다.
이름, 날짜, 메뉴, 한줄평을 저장하여 다른 친구들과 공유 할 수 있습니다.
...
📎 자세한 정보  
[lunch_archive 바로가기](https://github.com/KBohyeon/lunch_archive)
